...
#THEME
$(eval $(call AKS2C,assets/music/FinalSong.aks,song,src/music/,0x0040))

#SHOT SOUND
$(eval $(call AKS2C,assets/music/Shot.aks,SFX_shot,src/music/,0x0500))

#INTRO AND BOSS MUSIC
$(eval $(call AKS2C,assets/music/IntroAndBoss.aks,intro,src/music/,0x0560))

#POWER UP ACTIVE
$(eval $(call AKS2C,assets/music/PowerUp.aks,powerup,src/music/,0x06A0))

#FREE SPACE FROM 0x06A0
