...
//
// File assets/maps/g_F_4T2.tmx converted to csv using cpct_tmx2csv [20171028 01:11:18 CEST]
...
// Generated CSV tilemap from assets/maps/g_F_4T2.tmx
//   125 bytes (5 x 25)
//   10*25 items (4 bits per item)
//
#define g_F_4T2_W  5
#define g_F_4T2_H  25
extern const u8 g_F_4T2[5*25];
