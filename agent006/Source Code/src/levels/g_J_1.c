...
//
// File assets/maps/g_J_1.tmx converted to csv using cpct_tmx2csv [20171027 14:49:02 CEST]
...
#include <types.h>
#include <cpctelera.h>
CPCT_ABSOLUTE_LOCATION_AREA(0x2200);
// Generated CSV tilemap from assets/maps/g_J_1.tmx
const u8 g_J_1[5*25] = {
