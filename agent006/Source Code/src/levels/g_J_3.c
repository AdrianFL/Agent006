...
//
// File assets/maps/g_J_3.tmx converted to csv using cpct_tmx2csv [20171027 14:48:24 CEST]
...
#include <types.h>
#include <cpctelera.h>
CPCT_ABSOLUTE_LOCATION_AREA(0x2400);
// Generated CSV tilemap from assets/maps/g_J_3.tmx
const u8 g_J_3[5*25] = {
